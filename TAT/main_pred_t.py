...
from .train_pred_t import train_model
...
def parse_args():
    ...
    parser.add_argument('--timestep', type=list, default=-1, help='prediction timestep')
    ...
    # model training
    parser.add_argument('--model', type=str, default='TATT', choices=['TATT'], help='model name')
    ...
    parser.add_argument('--epoch', type=int, default=70, help='training epochs')
