...
from .train_seq_pred import train_model
...
def parse_args():
    ...
    # model training
    parser.add_argument('--model', type=str, default='TAT_seq_pred', choices=['TAT_seq_pred'], help='model name')
    ...
    parser.add_argument('--prevent_repeat', type=str2bool, default=False, help='prevent repetition in generated tokens')
